document.addEventListener('DOMContentLoaded', function () {
  ...
  enhanceBtn.addEventListener('click', async function () {
    ...
    const enhancedText = text.toUpperCase(); // Convert text to uppercase
    outputText.value = enhancedText;
    inputText.value = enhancedText;

    // Send message to content script to replace text in the selected field
    try {
